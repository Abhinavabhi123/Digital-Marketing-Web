    ...
    <div className="w-full h-full space-y-5">
      ...
      <div className="w-full min-h-[30rem] bg-transparent flex flex-col md:flex-row justify-center items-center">
        <div className="w-full h-full md:w-1/2 bg-transparent px-4 md:p-20 space-y-4 md:space-y-8">
          ...
          <div>
            <p
              className="text-xs md:text-sm tracking-wide text-gray-500"
              data-aos="fade-up"
              data-aos-delay="80"
            >
      ...
      <div className="w-full h-full flex justify-center pt-10 md:my-10">
        <div className="space-y-4">
          <div
            className="text-2xl md:text-5xl text-center md:tracking-wider md:space-y-4"
            data-aos="fade-up"
          >
          ...
          <p
            className="text-sm text-center text-gray-500 px-5 md:px-0"
            data-aos="fade-up"
          >
      ...
      <div className="w-full h-full flex flex-col items-center gap-12 md:py-10">
        ...
        <div>
          <div
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[0.1rem] bg-slate-500/50"
            data-aos="fade-up"
          >
            {seoData.map((item, i) => (
              <div
        ...
        <div className="w-full h-full bg-transparent flex flex-col md:flex-row">
          <div className="w-full h-full md:w-1/2 bg-transparent p-6 md:p-16 space-y-6">
            ...
            <div className="flex bg-transparent gap-8" data-aos="fade-right">
              <div>
                <h2 className="text-2xl md:text-4xl font-semibold flex">
                  ...
                  <p className="text-2xl md:text-4xl font-semibold">%</p>
                </h2>
              ...
              <div>
                <h2 className="text-2xl md:text-4xl font-semibold flex">
                  ...
                  <p className="text-2xl md:text-4xl font-semibold">M+</p>
                </h2>
            ...
            <div>
              <button
                className="px-3 py-2 rounded-full ring-1"
                data-aos="fade-right"
              >
                Learn More
              </button>
          ...
          <div className="w-full h-full md:w-1/2 bg-transparent p-10 md:p-20">
            <div
              className="w-full h-full min-w-60  rounded-2xl ring flex justify-center items-center"
              data-aos="fade-left"
            >
              <img
                src={Discussion}
